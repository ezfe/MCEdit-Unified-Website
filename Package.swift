...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/vapor/redis.git", from: "3.3.1"),
    ...
    targets: [
        .target(name: "App", dependencies: ["Vapor", "Leaf", "FluentPostgreSQL", "Redis", "SwiftMarkdown", "Authentication", "PwnedPasswords"]),
